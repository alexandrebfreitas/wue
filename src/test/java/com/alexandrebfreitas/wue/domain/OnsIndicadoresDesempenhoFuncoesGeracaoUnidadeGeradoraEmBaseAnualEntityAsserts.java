...
public class OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityAsserts {
     ...
     */
    public static void assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityAllPropertiesEquals(
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity expected,
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity actual
    ) {
        assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityAutoGeneratedPropertiesEquals(expected, actual);
        assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityAllUpdatablePropertiesEquals(
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity expected,
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity actual
    ) {
        assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityUpdatableFieldsEquals(expected, actual);
        assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityAutoGeneratedPropertiesEquals(
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity expected,
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity actual
    ) {
        assertThat(actual)
            .as("Verify OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityUpdatableFieldsEquals(
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity expected,
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity actual
    ) {
        assertThat(actual)
            .as("Verify OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity relevant properties")
            ...
            .satisfies(a -> assertThat(a.getDinAno()).as("check dinAno").isEqualTo(expected.getDinAno()))
     ...
     * @param actual the actual entity
     */
    public static void assertOnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntityUpdatableRelationshipsEquals(
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity expected,
        OnsIndicadoresDesempenhoFuncoesGeracaoUnidadeGeradoraEmBaseAnualEntity actual
    ) {
        // empty method
