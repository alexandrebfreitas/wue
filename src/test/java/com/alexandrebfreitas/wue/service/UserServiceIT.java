package com.alexandrebfreitas.wue.service;
...
import com.alexandrebfreitas.wue.repository.PersistentTokenRepository;
import com.alexandrebfreitas.wue.repository.UserRepository;
import com.alexandrebfreitas.wue.repository.search.UserSearchRepository;
...
class UserServiceIT {
    ...
    /**
     * This repository is mocked in the com.alexandrebfreitas.wue.repository.search test package.
     *
     * @see com.alexandrebfreitas.wue.repository.search.UserSearchRepositoryMockConfiguration
     */
    @MockitoSpyBean
    ...
    private void generateUserToken(UserEntity user, String tokenSeries, LocalDate localDate) {
