...
/**
 * A OnsCmoSemihorarioEntity.
 */
@Entity
@Table(name = "OnsTable44")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "onscmosemihorario")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OnsCmoSemihorarioEntity implements Serializable {
    ...
    public OnsCmoSemihorarioEntity id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public OnsCmoSemihorarioEntity idSubsistema(String idSubsistema) {
    ...
    public OnsCmoSemihorarioEntity nomSubsistema(String nomSubsistema) {
    ...
    public OnsCmoSemihorarioEntity dinInstante(LocalDate dinInstante) {
    ...
    public Double getValCmo() {
        return this.valCmo;
    }

    public OnsCmoSemihorarioEntity valCmo(Double valCmo) {
        this.setValCmo(valCmo);
        return this;
    }

    public void setValCmo(Double valCmo) {
        this.valCmo = valCmo;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OnsCmoSemihorarioEntity)) {
            return false;
        }
        return getId() != null && getId().equals(((OnsCmoSemihorarioEntity) o).getId());
    }
    ...
    public String toString() {
        return "OnsCmoSemihorarioEntity{" +
            "id=" + getId() +
