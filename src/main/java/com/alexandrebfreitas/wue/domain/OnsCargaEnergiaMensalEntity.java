...
/**
 * A OnsCargaEnergiaMensalEntity.
 */
@Entity
@Table(name = "OnsTable4")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@org.springframework.data.elasticsearch.annotations.Document(indexName = "onscargaenergiamensal")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class OnsCargaEnergiaMensalEntity implements Serializable {
    ...
    public OnsCargaEnergiaMensalEntity id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public OnsCargaEnergiaMensalEntity idSubsistema(String idSubsistema) {
    ...
    public OnsCargaEnergiaMensalEntity nomSubsistema(String nomSubsistema) {
    ...
    public OnsCargaEnergiaMensalEntity dinInstante(LocalDate dinInstante) {
    ...
    public OnsCargaEnergiaMensalEntity valCargaenergiamwmed(Double valCargaenergiamwmed) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof OnsCargaEnergiaMensalEntity)) {
            return false;
        }
        return getId() != null && getId().equals(((OnsCargaEnergiaMensalEntity) o).getId());
    }
    ...
    public String toString() {
        return "OnsCargaEnergiaMensalEntity{" +
            "id=" + getId() +
