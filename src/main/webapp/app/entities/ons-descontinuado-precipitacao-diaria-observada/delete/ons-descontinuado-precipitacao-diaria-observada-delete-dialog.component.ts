...
@Component({
  templateUrl: './ons-descontinuado-precipitacao-diaria-observada-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class OnsDescontinuadoPrecipitacaoDiariaObservadaDeleteDialogComponent {
  onsDescontinuadoPrecipitacaoDiariaObservada?: IOnsDescontinuadoPrecipitacaoDiariaObservada;
  ...
  confirmDelete(id: number): void {
    this.onsDescontinuadoPrecipitacaoDiariaObservadaService.delete(id).subscribe(() => {
