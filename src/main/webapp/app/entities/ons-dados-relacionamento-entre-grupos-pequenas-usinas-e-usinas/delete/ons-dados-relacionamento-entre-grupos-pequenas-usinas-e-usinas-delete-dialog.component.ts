...
@Component({
  templateUrl: './ons-dados-relacionamento-entre-grupos-pequenas-usinas-e-usinas-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class OnsDadosRelacionamentoEntreGruposPequenasUsinasEUsinasDeleteDialogComponent {
  ...
  confirmDelete(id: number): void {
    this.onsDadosRelacionamentoEntreGruposPequenasUsinasEUsinasService.delete(id).subscribe(() => {
