...
@Component({
  templateUrl: './ons-dados-programados-elementos-fluxo-controlado-delete-dialog.component.html',
  imports: [SharedModule, FormsModule],
})
export class OnsDadosProgramadosElementosFluxoControladoDeleteDialogComponent {
  onsDadosProgramadosElementosFluxoControlado?: IOnsDadosProgramadosElementosFluxoControlado;
  ...
  confirmDelete(id: number): void {
    this.onsDadosProgramadosElementosFluxoControladoService.delete(id).subscribe(() => {
